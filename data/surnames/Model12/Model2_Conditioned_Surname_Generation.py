...
args = Namespace(
    ...
    surname_csv="D:\\NLP\\data\\surnames\\surnames_with_splits.csv",
...
# === 根据学号尾数选择语言 ===
# 修改这个值为你的学号尾数
student_id_last_digit = 3  # 👈 修改为你的学号尾数
...
# 获取对应的语言
target_nationality = nationality_map[student_id_last_digit]
print(f"\n根据学号尾数选择的语言是：{target_nationality}")

# 获取对应 nationality 的索引
...
sampled_indices = sample_from_model(model, vectorizer,
                                    ...
                                    temperature=0.7)
sampled_surnames = decode_samples(sampled_indices, vectorizer)

print(f"\n{target_nationality} 风格的生成姓氏：")
